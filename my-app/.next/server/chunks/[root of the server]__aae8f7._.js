...
async function handler(req, res) {
    ...
    switch(req.method){
        case "GET":
            ...
            if (!userId || !__TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["Types"].ObjectId.isValid(userId)) {
            ...
            try {
                ...
                const transactions = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$TransactionModel$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].find({
        ...
        case "POST":
            ...
            if (!__TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["Types"].ObjectId.isValid(postUserId)) {
                return res.status(400).json({
                    message: "Invalid User ID"
                });
            }
            try {
                ...
                const newTransaction = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$TransactionModel$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"]({
                    userId: new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["Types"].ObjectId(postUserId),
                    type,
                    amount,
                    description,
                    date: new Date(date)
        ...
        case "DELETE":
            ...
            try {
                ...
                const deletedTransaction = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$TransactionModel$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].findByIdAndDelete(transactionId);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__aae8f7._.js.map