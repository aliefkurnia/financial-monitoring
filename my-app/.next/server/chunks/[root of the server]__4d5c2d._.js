        ...
        try {
            ...
            if (!db) {
                return res.status(500).json({
                    message: "Database tidak terhubung dengan benar"
                });
            }
            const expenses = await db.collection("expenses").find({
                userId: new __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__["ObjectId"](userId)
            }).toArray();
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__4d5c2d._.js.map