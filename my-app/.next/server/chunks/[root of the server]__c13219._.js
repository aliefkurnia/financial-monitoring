...
"[project]/src/models/IncomeModel.ts [api] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__ = __turbopack_import__("[externals]/mongoose [external] (mongoose, cjs)");
;
const IncomeSchema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].Schema({
    userId: {
        type: __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].Schema.Types.ObjectId,
        ref: "User"
    },
...
const Income = __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].models.Income || __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].model("Income", IncomeSchema);
const __TURBOPACK__default__export__ = Income;
}}),
"[project]/src/models/ExpenseModel.ts [api] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$IncomeModel$2e$ts__$5b$api$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/models/IncomeModel.ts [api] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$ExpenseModel$2e$ts__$5b$api$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/models/ExpenseModel.ts [api] (ecmascript)");
...
async function handler(req, res) {
    ...
    switch(req.method){
        case "POST":
            ...
            // Validate date to ensure it's a valid date string
            ...
            try {
                ...
                if (type === "income") {
                    newTransaction = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$IncomeModel$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"]({
                    ...
                    newTransaction = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$ExpenseModel$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"]({
                        userId: new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["Types"].ObjectId(userId),
                        amount,
                        description,
                        date: parsedDate
                ...
                // Save the new transaction to the respective collection
                await newTransaction.save();
                // Find the user and update their transactions array
                ...
                // Add the transaction's ID to the user's transactions array
        ...
        case "GET":
            ...
            try {
                // If `lastSummary` is true, fetch the latest 5 transactions
                if (lastSummary === "true") {
                ...
                // If transactionType is specified, filter transactions by type (income or expense)
                if (transactionType && (transactionType === "income" || transactionType === "expense")) {
                    // Fetch data from the respective collection
                    if (transactionType === "income") {
                        const incomeTransactions = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$IncomeModel$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].find(filter);
                        return res.status(200).json(incomeTransactions);
                    } else if (transactionType === "expense") {
                        const expenseTransactions = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$ExpenseModel$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].find(filter);
                        return res.status(200).json(expenseTransactions);
                    }
                }
                // Fetch all transactions if no type is specified
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__c13219._.js.map