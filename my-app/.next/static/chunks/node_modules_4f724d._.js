(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_4f724d._.js", {
...
"[project]/node_modules/svg-partial-circle/index.js [client] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/react-minimal-pie-chart/dist/index.esm.js [client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$svg$2d$partial$2d$circle$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/svg-partial-circle/index.js [client] (ecmascript)");
;
;
...
function ReactMinimalPieChartLabel({ renderLabel, labelProps }) {
    ...
    if (typeof label === 'string' || typeof label === 'number') {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].createElement("text", {
            dominantBaseline: "central",
            ...props
        }, label);
    }
    if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].isValidElement(label)) {
        return label;
    }
    return null;
}
...
function renderLabels(data, props) {
    const { label } = props;
    if (label) {
        return makeLabelRenderProps(data, props).map((labelRenderProps, index)=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].createElement(ReactMinimalPieChartLabel, {
...
function makePathCommands(cx, cy, startAngle, lengthAngle, radius) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$svg$2d$partial$2d$circle$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"])(cx, cy, radius, degreesToRadians(startAngle), degreesToRadians(startAngle + patchedLengthAngle)).map((command)=>command.join(' ')).join(' ');
}
function ReactMinimalPieChartPath({ cx, cy, lengthAngle, lineWidth, radius, shift = 0, reveal, rounded, startAngle, title, ...props }) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].createElement("path", {
        d: pathCommands,
        fill: "none",
        ...
        ...props
    }, title && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].createElement("title", null, title));
}
...
function renderSegments(data, props, revealOverride) {
    ...
    const paths = data.map((dataEntry, index)=>{
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].createElement(ReactMinimalPieChartPath, {
            cx: cx,
            cy: cy,
    ...
    if (props.background) {
        paths.unshift(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].createElement(ReactMinimalPieChartPath, {
            cx: cx,
            cy: cy,
            key: "bg",
...
function ReactMinimalPieChart(originalProps) {
    ...
    const [revealOverride, setRevealOverride] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(props.animate ? 0 : null);
...
//# sourceMappingURL=node_modules_4f724d._.js.map