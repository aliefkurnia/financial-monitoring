(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__d6bc81._.js", {
...
const Register = ()=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        setErrorMessage("");
        try {
            const response = await fetch(`${("TURBOPACK compile-time value", "http://localhost:3000")}/api/users/register`, {
                method: "POST",
                headers: {
            ...
            if (response.ok) {
                ...
                setErrorMessage(errorData.message || "Terjadi kesalahan, coba lagi.");
            }
        } catch (error) {
            console.error("Error saat registrasi:", error); // Log untuk memeriksa error
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        type: "submit",
                        className: "w-full bg-blue-600 text-white py-2 px-6 rounded-lg shadow-md hover:bg-blue-700 transition duration-300",
...
_s(Register, "hzMpbMTS6WKgoGzuedBWivt5Mvk=", false, function() {
    return [
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__d6bc81._.js.map